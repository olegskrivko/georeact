...
// import shelterIcon from '../../assets/map_icons/qr-code.png';
...
import qrIcon from '../../assets/map_icons/qr-code.png';
...
function LeafletPostersMap({ posters = [], pets, mapCenter, isLoading, userLocation, mapRef }) {
  // const [userLocation, setUserLocation] = useState(null);
  // const theme = useTheme();
  // const isSmallScreen = useMediaQuery(theme.breakpoints.down('sm'));
  // const mapHeight = isSmallScreen ? '240px' : '500px';
                  ...
                  >
                    ...
                    <div
                      style={{
                        height: 3,
                        width: '100%',
                        background: 'linear-gradient(90deg, #5B9BD5 0%, #00b5ad 100%)',
                        marginBottom: 0,
                      }}
                    />
                    {(() => {
                    ...
                    <div style={{ padding: '8px 8px 8px 8px' }}>
                      ...
                      <p style={{ margin: 0, fontWeight: 500, color: '#555', fontSize: 13 }}>
                        Scans: {poster.scans ?? 'N/A'}
                      </p>
                    </div>
                  </div>
                </Popup>
