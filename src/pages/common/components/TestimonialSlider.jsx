...
//   },
//   {
//     quote: 'This app helped me find my dog in just 48 hours. Amazing!',
//     name: 'Anna L.',
//     role: 'Pet Owner',
//   },
//   {
...
export default function TestimonialSlider({ dotsPosition = 'center' }) {
  ...
  useEffect(() => {
    ...
    fetch(`${API_BASE_URL}/api/feedbacks/testimonials/`)
      .then((res) => res.json())
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {testimonials
            .filter((t) => t.is_visible) // show only visible testimonials
            .map((t) => (
