    ...
    >
      ...
      > */}
        ...
        >
          ...
          >
            Learn how to best care for your pet – from daily care to emergency situations. Practical tips, guides, and
            answers to important questions all in one place.
          </p>
          {/* Button Group */}
          <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
            ...
            <Button variant="contained" sx={{ borderRadius: 2 }} color="primary" onClick={() => navigate('/guides')}>
              View Tips
            </Button>
          </div>
        </div>
