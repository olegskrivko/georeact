...
const ChatBot = () => {
  ...
  const predefinedQuestions = ['How can I help you?', 'What pets are available?', 'How do I report a lost pet?'];
  ...
  const sendMessageToBackend = async (message) => {
    try {
      ...
      //   ...prev,
      //   {
      //     text: data.response || 'Sorry, I did not understand the question.',
      //     isUser: false,
      //   },
      // ]);
      const data = await response.json();
      ...
      const newMessages = [
        {
          text: data.reply || 'Sorry, I did not understand the question.',
          isUser: false,
        },
      ];
