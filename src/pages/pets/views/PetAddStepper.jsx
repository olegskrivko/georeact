...
const steps = ['Pet Characteristics', 'Location', 'Images', 'Appearance', 'Contact Information'];
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (typeof errData === 'object' && errData !== null) {
        ...
        setServerError('Error adding pet.');
      }
        ...
        <Box>
          ...
          {activeStep < steps.length - 1 && (
            <Typography variant="body2" sx={{ mt: 1, color: 'gray' }}>
              Next step: {steps[activeStep + 1]} {/* Next step name as subtitle */}
            </Typography>
          )}
        </Box>
      </Box>
