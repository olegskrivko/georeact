...
const StatusHistory = ({ pet, sightings }) => {
  ...
  const formattedTime = eventDate ? format(eventDate, 'HH:mm', { locale: enUS }) : 'Not available';
  ...
  const formattedDateCreatedAt = eventDateCreatedAt
    ? format(eventDateCreatedAt, 'd. MMMM yyyy', { locale: enUS })
    : 'Not available';

  const formattedTimeCreatedAt = eventDateCreatedAt
    ? format(eventDateCreatedAt, 'HH:mm', { locale: enUS })
    : 'Not available';
            ...
            <List sx={{ paddingTop: '0 !important' }}>
              ...
              {pet.event_occurred_at && (
                <ListItem sx={{ paddingLeft: 0 }}>
                  ...
                  <ListItemText primary={'Pet ' + `${pet.status.toLowerCase()} ` + `${formattedDate}`} />
                </ListItem>
              )}
              ...
              {pet.created_at && (
                <ListItem sx={{ paddingLeft: 0 }}>
                  ...
                  <ListItemText primary={'Advertisement posted ' + `${formattedDateCreatedAt}`} />
                </ListItem>
              )}
              ...
              {validSightings.length > 0 ? (
                ...
                <ListItem sx={{ paddingLeft: 0 }}>
                  ...
                  <ListItemText primary="No sightings available." />
                </ListItem>
              )}
              ...
              <ListItem sx={{ paddingLeft: 0 }}>
                ...
                <ListItemText primary={`Final status: ${pet.final_status}`} />
              </ListItem>
            </List>
          </CardContent>
        </Card>
