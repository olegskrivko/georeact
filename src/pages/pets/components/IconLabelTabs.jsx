    ...
    <Box sx={{ margin: '0rem !important', padding: '0rem !important' }}>
      <div style={{ margin: '1rem 0' }}>
        <Tabs value={value} centered onChange={handleChange} variant="fullWidth" aria-label="basic tabs example">
          <Tab icon={<ForumIcon />} label="Messages" sx={{ fontSize: '0.7rem' }} {...a11yProps(0)} />
          <Tab icon={<DescriptionIcon />} label="Notes" sx={{ fontSize: '0.7rem' }} {...a11yProps(1)} />

          <Tab icon={<ContactPageIcon />} label="Contacts" sx={{ fontSize: '0.7rem' }} {...a11yProps(2)} />
        </Tabs>
      </div>
